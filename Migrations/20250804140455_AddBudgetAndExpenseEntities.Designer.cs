...
namespace Sonic.API.Migrations
{
    ...
    [Migration("20250804140455_AddBudgetAndExpenseEntities")]
    partial class AddBudgetAndExpenseEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sonic.API.Models.Budgets.Budget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Budgets", null, t =>
                        {
                            t.HasCheckConstraint("CK_Budget_Owner", "(\"ArtistId\" IS NOT NULL AND \"VenueId\" IS NULL) OR (\"ArtistId\" IS NULL AND \"VenueId\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Sonic.API.Models.Budgets.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Sonic.API.Models.Tours.Tour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Sonic.Models.ResourceMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TourUser", b =>
                {
                    ...
                    b.HasKey("ArtistsId", "ToursId");

                    b.HasIndex("ToursId");

                    b.ToTable("TourArtists", (string)null);
                });
            ...
            modelBuilder.Entity("Sonic.API.Models.Budgets.Budget", b =>
                {
                    b.HasOne("Sonic.Models.Artist", "Artist")
                        .WithMany()
                        .HasForeignKey("ArtistId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Sonic.Models.Event", "Event")
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Sonic.API.Models.Tours.Tour", "Tour")
                        .WithMany()
            ...
            modelBuilder.Entity("Sonic.API.Models.Budgets.Expense", b =>
                {
                    b.HasOne("Sonic.Models.User", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Sonic.API.Models.Budgets.Budget", "Budget")
                        .WithMany("Expenses")
                        .HasForeignKey("BudgetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sonic.Models.User", "SubmittedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Sonic.Models.ResourceMembership", b =>
                {
                    b.HasOne("Sonic.Models.User", "User")
                        .WithMany("ResourceMemberships")
            ...
            modelBuilder.Entity("TourUser", b =>
                {
                    ...
                    b.HasOne("Sonic.API.Models.Tours.Tour", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sonic.Models.User", b =>
                {
                    b.Navigation("ResourceMemberships");
                });
